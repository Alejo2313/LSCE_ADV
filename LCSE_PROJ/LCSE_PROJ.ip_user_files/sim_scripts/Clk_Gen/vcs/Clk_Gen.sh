...
#
# Generated by Vivado on Fri Oct 09 17:46:53 +0200 2020
...
# Script info
echo -e "Clk_Gen.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../LCSE_PROJ.srcs/sources_1/ip/Clk_Gen/Clk_Gen_clk_wiz.v" \
    "$ref_dir/../../../../LCSE_PROJ.srcs/sources_1/ip/Clk_Gen/Clk_Gen.v" \
  2>&1 | tee -a vlogan.log
